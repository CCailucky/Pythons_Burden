...
from events import handle_events as handle_keyboard_events
...
class GameController:
    ...
    def update_snake_tick(self, current_time: int) -> None:
        ...
        is_tail_cut_eaten = eaten_tail_cut_item is not None
        is_bullet_supply_eaten = eaten_bullet_supply_item is not None
    ...
    # for main to update the game logic
