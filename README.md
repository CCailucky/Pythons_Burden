...
USYD COMP9001 Final Project by Lucky Cai

## Overview

**Python's Burden: Escape from COMP9001** is a Pygame-based snake adventure game developed for the USYD COMP9001 final project.
